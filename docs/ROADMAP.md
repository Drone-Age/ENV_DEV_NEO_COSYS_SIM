...
- [in progress] Preserve the production iHUB/UART gimbal contract. The pinned iHUB compatibility branch now has a tested Cosys camera-pose HAL; runtime acceptance still requires iHUB handshake, 0-90 degree setpoint/status agreement and camera-IMU motion during the tilt before enabling VINS.
